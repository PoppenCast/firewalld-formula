...
%global tag poppencast-salt-formula-firewalld-0.0.1-1
%forgemeta
...
%install
install -d -m 755 %{buildroot}%{_datadir}/salt/firewalld-formula
cp -R --no-dereference --preserve=mode,links -v firewalld %{buildroot}%{_datadir}/salt/firewalld-formula/

%check
# TODO: build and testing, for now this package only "zips up"

%files
%{_datadir}/salt/firewalld-formula/
%doc docs/README.rst
%license LICENSE
